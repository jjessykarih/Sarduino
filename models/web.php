...
<body>
    ...
    <div class="panel-group">
      <div class="panel panel-info">
        <div class="panel-heading"><center><img src="/Sarduino/models/imagen/banner1.jpg" width="1300px" height="250px"></center> </div>
        <div class="panel-body">
          <div class="col-lg-12">
            <div class="col-sm-3">
              <center><button onclick="location.href='/Sarduino/models/views/index.php' " type="button" class="btn btn-warning btn-lg">GRAFICO T1 & T2</button></center>
                </div>
                <div class="col-sm-3">
              <center><button onclick="location.href='/Sarduino/models/views/index.php' " type="button" class="btn btn-success btn-lg">GRAFICO GENERAL</button></center>
                </div>
                <div class="col-sm-3">
              <center><button onclick="location.href='/Sarduino/models/views/index.php' " type="button" class="btn btn-primary btn-lg">GRAFICO I-PH-OX</button></center>
            </div>
            <div class="col-sm-3">
          ...
          <div class="col-lg-12">
            ...
            <div class="col-md-6">
              <div class="panel panel-success">
                  <div class="panel-heading">
                    <center><img src="/Sarduino/models/imagen/t1.jpg" width="150" height="150"></center> 
            ...
            <div class="col-md-6">
              <div class="panel panel-danger">
                  <div class="panel-heading">
                    <center><img src="/Sarduino/models/imagen/oxi.jpg" width="300" height="150"></center>
