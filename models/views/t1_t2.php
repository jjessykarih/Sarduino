...
<html>
	<head>
    <center><img src="/Sarduino/models/views/grafico.png" alt="temp" width="100" height="100"></center>
        ...
        series: [{
            ...
            data: [
            <?php
                $query = " select t1 from sensors order by id desc limit 10 ";
            ...
            data: [
            <?php
                $query = " select t2 from sensors order by id desc limit 10 ";
                $resultados = mysqli_query($connection, $query);
                while($rows = mysqli_fetch_array($resultados)){
                    ?>
                        <?php echo $rows["t2"]?>,
...
<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto">
    ...
    <center><button onclick="location.href='/Sarduino/models/web.php' " class="btn btn-warning btn-lg"><strong>ATRAS</strong></button>
</html></center> 
