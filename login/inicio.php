  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="/Sarduino/models/web.php" method="post" >
...
<div class="modal fade bs-example-modal-md-registrar" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="/Sarduino/login/inicio.php" method="post">
              <div class="form-group">
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="../login/imagen/ny.png" alt="New York" width="1000" height="500">
      ...
      <div class="item">
        <img src="../login/imagen/chicago.jpg" alt="Chicago" width="1000" height="500">
        <div class="carousel-caption">
          <h3>Distracción</h3>
      ...
      <div class="item">
        <img src="../login/imagen/la.jpg" alt="Los Angeles" width="1000" height="500">
        <div class="carousel-caption">
          <h3>Reflexión</h3>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <a href="#demo" data-toggle="collapse">
        <img src="../login/imagen/bandmember.jpg" class="img-rounded" alt="Random Name" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo2" data-toggle="collapse">
        <img src="../login/imagen/salado.jpg" class="img-rounded" alt="Random Name" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo3" data-toggle="collapse">
        <img src="../login/imagen/tropicales.jpg" class="img-rounded" alt="Random Name" width="255" height="255">
      </a>
